...
consider the security implications before doing this
...
- the Prism Central username; the script will prompt for the user's password so that it never needs to be stored in plain text 
"""
...
cluster_password = getpass.getpass( prompt="Enter your Prism Central \
...
if __name__ == "__main__":
    ...
    try:
        ...
        images_list = api_instance.list_images(async_req=False)
